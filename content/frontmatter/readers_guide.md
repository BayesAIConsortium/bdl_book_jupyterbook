...
Bayesian deep learning (BDL) asks how the machinery of Bayesian inference—priors, posteriors, predictive distributions, marginal likelihoods, and the decisions they license—can be brought to bear on models with millions or billions of parameters, for which none of the classical guarantees or algorithms apply unmodified. This book covers that question in ten parts. Five of them develop the major families of approximate inference used in practice: Monte Carlo sampling ([Part 1](#part:sampling_methods)), Laplace approximations ([Part 2](#part:laplace_approximations)), variational inference ([Part 3](#part:vi)), ensembles ([Part 4](#part:ensemble_methods)), and kernel and Gaussian-process methods ([Part 5](#part:kernel_methods)). Two cover the modelling questions that are assumed as prerequisites by the aforementioned algorithms: what a prior over a neural network actually means ([Part 6](#part:priors)), and what the symmetries and non-identifiability of neural parameterisations do to inference and interpretation ([Part 7](#part:identifiability_and_symmetries)). One is devoted to making all of this run at modern scale ([Part 8](#part:scalability)), one to worked applications and software ([Part 9](#part:applications)), and the last to topics at the current research frontier, from diffusion models and singular learning theory to causal, credal, and reinforcement-learning extensions ([Part 10](#part:topical_developments)). The parts are largely parallel rather than sequential: they are alternative and complementary answers to the same problem, and comparing them is a large part of what the book is for.
...
:::{table} Table 1. Chapter-level prerequisites for Parts~[1](#part:sampling_methods)–[5](#part:kernel_methods). ``Read first'' lists the chapters a chapter leans on; ``also useful'' lists chapters that deepen it but are not required.
:label: tab:readerguide:prereq-early

| Ch. | Topic | Read first | Also useful |
| --- | --- | --- | --- |
***[Part 1](#part:sampling_methods): Sampling methods***
...
| [7](#cha:laplace:introduction) | Introduction to Laplace approximations | — | [Part 1](#part:sampling_methods), for contrast |
| --- | --- | --- | --- |
...
***[Part 3](#part:vi): Variational inference***
...
***[Part 4](#part:ensemble_methods): Ensemble methods***
...
***[Part 5](#part:kernel_methods): Kernel methods***
...
:::{table} Table 2. Chapter-level prerequisites for Parts~[6](#part:priors)–[10](#part:topical_developments). Conventions as in [Table 1](#tab:readerguide:prereq-early).
:label: tab:readerguide:prereq-late

| Ch. | Topic | Read first | Also useful |
| --- | --- | --- | --- |
***[Part 6](#part:priors): Priors***
...
***[Part 7](#part:identifiability_and_symmetries): Identifiability and symmetries***
...
***[Part 8](#part:scalability): Scalability***
...
***[Part 9](#part:applications): Applications***
...
***[Part 10](#part:topical_developments): Topical developments***
